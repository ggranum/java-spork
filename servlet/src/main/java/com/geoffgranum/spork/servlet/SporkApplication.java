 ...
 * @author ggranum
 */
public abstract class SporkApplication {

  private final Bootstrap bootstrap;
  private final BootstrapConfiguration baseConfig;

  public SporkApplication(Bootstrap bootstrap, BootstrapConfiguration baseConfig) {
  ...
  private ServletContextHandler addServletContext(Server server) {
    ...
    SporkServletContextListener contextListener = bootstrap.createContextListener(baseConfig);
