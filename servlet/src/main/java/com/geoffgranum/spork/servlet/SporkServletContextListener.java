...
public class SporkServletContextListener extends ResteasyGuiceServletContextListener {

  private final int httpPort;
  private final int httpsPort;
  private final Injector injector;

  public SporkServletContextListener(int httpPort, int httpsPort, Injector injector) {
